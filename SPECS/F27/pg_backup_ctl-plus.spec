...
BuildRequires: popt-devel readline-devel
Requires: libpgbckctl-common
Provides: pg_backup_ctl++
...
CXXFLAGS="-D__DEBUG__ -D__DEBUG_XLOG__" \
        CXX="ccache g++" \
        cmake -DPG_BACKUP_CTL_SQLITE:FILEPATH=/var/lib/pg_backup_ctl-plus/pg_backup_ctl.sqlite \
...
Group:   Application/Databases
License: GPLv3
BuildRequires: boost-devel libzstd-devel cmake gcc-c++ ccache gettext-devel sqlite-devel postgresql%{upstream_pgdg_version}-devel
