...
#define SQL_ARCHIVE_DIRECTORY_ATTNO 1
#define SQL_ARCHIVE_COMPRESSION_ATTNO 2
#define SQL_ARCHIVE_PGHOST_ATTNO 3
#define SQL_ARCHIVE_PGPORT_ATTNO 4
#define SQL_ARCHIVE_PGUSER_ATTNO 5
#define SQL_ARCHIVE_PGDATABASE_ATTNO 6
