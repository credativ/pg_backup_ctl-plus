...
namespace credativ {
  ...
  public:
    ...
    /**
     * Tells the background job to execute the specified
     * executable with execArgs arguments. This uses Boost::Process and
     * replaces the child process context with the executable specified.
     * If the command exits, the child will be terminated accordingly.
     */
